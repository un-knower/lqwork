...
public class HttpUtil {
	...
	public  Map<String, Object> sendHttpRequest(String targetSys,String targetService,String paramsStr,String sendType){
...
//		httpCfgParamMap.put("easyLinkGatherRequestService", "/BAbillPool/BAbillPoolCheckSuccess.action");
	...
	public  boolean sendMsg(String phone,String msgContent) {
		...
		if (smsEnable == null || smsEnable.isEmpty() || !smsEnable.equalsIgnoreCase("true")) {
			System.out.println("SMS发送被关闭，如需打开，请配置sms.enable=true(config.properties)");
			return true;
		}
